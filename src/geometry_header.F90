module geometry_header
  ...
  use constants, only: HALF, TWO, THREE, LATTICE_RECT, LATTICE_HEX
...
!===============================================================================
  ...
  type :: Lattice
    ...
    ! Rectangular lattice properties
    ...
    procedure :: are_valid_indices => valid_inds
    procedure :: get_indices => get_inds
    procedure :: get_local_xyz => get_local
  end type Lattice
...
!===============================================================================
  ...
  function valid_inds(this, i_xyz) result(is_valid)
    class(Lattice), intent(in) :: this
    integer,        intent(in) :: i_xyz(3)
    logical                    :: is_valid

    if (this % type == LATTICE_RECT) then
  ...
  end function valid_inds

!===============================================================================

  function get_inds(this, global_xyz) result(i_xyz)
    class(Lattice), intent(in) :: this
  ...
  end function get_inds

!===============================================================================

  function get_local(this, global_xyz, i_xyz) result(local_xyz)
    class(Lattice), intent(in) :: this
    real(8),        intent(in) :: global_xyz(3)
    integer,        intent(in) :: i_xyz(3)
    real(8)                    :: local_xyz(3)
